...
{
public:
    SAVectorDouble(){setData (SA::VectorDouble,SA_ROLE_DATA_TYPE);}
    SAVectorDouble(const QString & name):SAVectorDatas<double>(name){setData (SA::VectorDouble,SA_ROLE_DATA_TYPE);}
