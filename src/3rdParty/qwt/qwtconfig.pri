...
contains(QT_ARCH, i386) {
    ...
    msvc:QWT_INSTALL_LIBS=$${QWT_INSTALL_PREFIX}/lib/msvc_64/$${QT_MAJOR_VERSION}_$${QT_MINOR_VERSION}_$${QT_PATCH_VERSION}
    mingw:QWT_INSTALL_LIBS=$${QWT_INSTALL_PREFIX}/lib/mingw32_64/$${QT_MAJOR_VERSION}_$${QT_MINOR_VERSION}_$${QT_PATCH_VERSION}
}
}
unix{
