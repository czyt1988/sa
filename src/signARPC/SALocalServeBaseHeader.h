...
/// \def 登录请求(1-1)功能号
#define SA_LOCAL_SER_FUN_LOGINED 1
...
/// \def 握手请求(2-1)功能号
#define SA_LOCAL_SER_FUN_SHAKEHAND 1
...
/// \def 字符串类3-1
#define SA_LOCAL_SER_FUN_STRING 1
/// \def 2D序列类型
#define SA_LOCAL_SER_FUN_POINT_SERIE_STATISTIC 2
/// \def 二进制类型
#define SA_LOCAL_SER_FUN_SEND_BIN 99
...
/// \def 普通错误4-1
#define SA_LOCAL_SER_FUN_OCCUR_ERROR 1
...
///
struct SARPC_EXPORT SALocalServeBaseHeader
{
...
SARPC_EXPORT QDataStream& operator <<(QDataStream& io,const SALocalServeBaseHeader& d);
SARPC_EXPORT QDataStream& operator >>(QDataStream& io,SALocalServeBaseHeader& d);
SARPC_EXPORT QDebug operator<<(QDebug debug, const SALocalServeBaseHeader &c);
